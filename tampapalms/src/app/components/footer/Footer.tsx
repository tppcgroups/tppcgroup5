  ...
  return (
    <footer className="relative overflow-hidden border-t border-stone-900 bg-neutral-950 text-stone-200">
      ...
      <div className="relative">
        <div className="flex flex-col items-center text-center gap-12 sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:text-left sm:items-start">
          <div className="container mx-auto px-6 py-16 md:px-10 lg:px-16">
            <div className="mt-16 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4 ">
              <div className="space-y-6">
                <div className="space-y-2 md:border-l border-white/10 md:pl-4 text-sm text-stone-300">
              ...
              {/* Quick Links Section */}
              <div>
                <h3 className="text-sm font-semibold uppercase text-center tracking-[0.3em] text-white">
                  Quick Links
                </h3>
                <nav className="mt-6 grid gap-3 text-sm text-center sm:text-left sm:justify-items-start justify-items-center">
                  {quickLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
            ...
            <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
              <h3 className="text-sm font-semibold uppercase tracking-[0.3em] text-white">
                ...
                <div className="mt-6 flex w-full flex-col items-center gap-4 text-sm text-stone-300 sm:items-start">
                  <a
                    href="tel:8138767697"
                    className="flex w-full max-w-xs items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 transition hover:border-white sm:max-w-none sm:justify-start"
                  >
